...
issue](https://github.com/cisagov/pre-commit-shfmt/issues) in this
...
request](https://github.com/cisagov/pre-commit-shfmt/pulls), you will
...
```console
cd pre-commit-shfmt
pyenv virtualenv <python_version_to_use> pre-commit-shfmt
pyenv local pre-commit-shfmt
